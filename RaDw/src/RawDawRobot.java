...
public class RawDawRobot {
	...
	public void tourner(float angle, boolean m){
		pilot.rotate(angle, m);
	}
	
	public boolean isPilotMoving(){
	...
	public boolean putPaletInGoal(){
		currentColor = 	ColorDetector.getMoyeneColor();
